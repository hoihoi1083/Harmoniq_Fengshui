...
OUTPUT_BASE_DIR = "/Users/michaelng/Desktop/marketing/天然彩胶花水晶手链_ad_material_20260507"
...
# --- Marketing Texts ---
marketing_texts_tc = {
    "multi_hematoid_cover.png": ("天然彩膠花水晶手鏈", "色彩斑斕·招財納福"),
    "multi_hematoid_01.png": ("晶瑩剔透", "內含乾坤"),
    "multi_hematoid_02.png": ("天然礦景", "如花綻放"),
    "multi_hematoid_03.png": ("獨一無二", "自然之美"),
    "multi_hematoid_04.png": ("氣質百搭", "點亮腕間"),
    "multi_hematoid_05.png": ("豐富色彩", "活力四射"),
    "multi_hematoid_06.png": ("日常穿搭", "彰顯個性"),
    "multi_hematoid_07.png": ("陽光折射", "光彩奪目"),
    "multi_hematoid_08.png": ("靜享時光", "感受自然"),
    "multi_hematoid_09.png": ("細膩質感", "匠心挑選"),
    "multi_hematoid_10.png": ("浪漫點綴", "遇見美好"),
    "multi_hematoid_11.png": ("護身祈福", "好運連連"),
}

marketing_texts_sc = {
    "multi_hematoid_cover.png": ("天然彩胶花水晶手链", "色彩斑斓·招财纳福"),
    "multi_hematoid_01.png": ("晶莹剔透", "内含乾坤"),
    "multi_hematoid_02.png": ("天然矿景", "如花绽放"),
    "multi_hematoid_03.png": ("独一无二", "自然之美"),
    "multi_hematoid_04.png": ("气质百搭", "点亮腕间"),
    "multi_hematoid_05.png": ("丰富色彩", "活力四射"),
    "multi_hematoid_06.png": ("日常穿搭", "彰显个性"),
    "multi_hematoid_07.png": ("阳光折射", "光彩夺目"),
    "multi_hematoid_08.png": ("静享时光", "感受自然"),
    "multi_hematoid_09.png": ("细腻质感", "匠心挑选"),
    "multi_hematoid_10.png": ("浪漫点缀", "遇见美好"),
    "multi_hematoid_11.png": ("护身祈福", "好运连连"),
}
...
def add_border_and_shadow(img, border_size=4, shadow_size=20, shadow_opacity=60):
    # Use a soft, warm off-white border
...
def process_promo():
    print("Generating gifted report promo image (Artistic Canvas Style)...")
    
    # 1. Background - Artistic Canvas Style
    bg_path = os.path.join(ASSETS_DIR, "multi_hematoid_report_bg.png")
    bg = Image.open(bg_path).convert("RGB")
    bg = ImageOps.fit(bg, (TARGET_WIDTH, TARGET_HEIGHT), Image.Resampling.LANCZOS)
    
    # Subtle white overlay on the left to make text readable against the bright canvas
    ...
    # Paste reports onto bg - "Gallery Display" layout (side-by-side, slightly offset vertically)
    center_x = TARGET_WIDTH // 2 + 150
    
    bg.paste(r1_styled, (center_x - r1_styled.width + 20, (TARGET_HEIGHT - r1_styled.height)//2 - 30), r1_styled)
    bg.paste(r2_styled, (center_x + 60, (TARGET_HEIGHT - r2_styled.height)//2 + 30), r2_styled)
    ...
    texts = {
        "TC": [("結緣贈送", 110), ("專屬八字五行分析報告", 60), ("色彩斑斕 · 招財納福", 45)],
        "SC": [("结缘赠送", 110), ("专属八字五行分析报告", 60), ("色彩斑斓 · 招财纳福", 45)]
    }
    ...
    for lang, lines in texts.items():
        ...
        for text, size in lines:
            ...
            # Dark charcoal text with white shadow for bright canvas background
            draw_text_with_shadow(draw, (120, y_offset), text, font, (40, 40, 40), (255,255,255,180))
            y_offset += size + 40

        out_dir = os.path.join(OUTPUT_BASE_DIR, lang)
        os.makedirs(out_dir, exist_ok=True)
        out_path = os.path.join(out_dir, "12_multi_hematoid_report_promo.png")
        img_copy.convert("RGB").save(out_path, "PNG")
        print(f"Saved {out_path}")

def main():
    print("Processing Multi-colored Hematoid Quartz images...")
    
    process_image("multi_hematoid_cover.png", "00_multi_hematoid_cover.png", 
                  marketing_texts_tc["multi_hematoid_cover.png"], 
                  marketing_texts_sc["multi_hematoid_cover.png"], 
                  is_front=True)
                  
    images_to_process = [
        "multi_hematoid_01.png", "multi_hematoid_02.png", "multi_hematoid_03.png", "multi_hematoid_04.png",
        "multi_hematoid_05.png", "multi_hematoid_06.png", "multi_hematoid_07.png", "multi_hematoid_08.png",
        "multi_hematoid_09.png", "multi_hematoid_10.png", "multi_hematoid_11.png"
    ]
    
    for i, img_key in enumerate(images_to_process, 1):
        out_name = f"{i:02d}_multi_hematoid.png"
