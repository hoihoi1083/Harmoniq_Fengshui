...
OUTPUT_BASE_DIR = "/Users/michaelng/Desktop/marketing/粉白雪花手串_ad_material_20260508"
...
# --- Marketing Texts ---
marketing_texts_tc = {
    "pink_snowflake_cover.png": ("粉白雪花手串", "冰清玉潔·浪漫守護"),
    "pink_snowflake_01.png": ("溫婉動人", "氣質穿搭"),
    "pink_snowflake_02.png": ("浪漫氣息", "點綴腕間"),
    "pink_snowflake_03.png": ("晶瑩剔透", "雪花內景"),
    "pink_snowflake_04.png": ("復古情懷", "歲月靜好"),
    "pink_snowflake_05.png": ("詩意生活", "藝術之美"),
    "pink_snowflake_06.png": ("柔美色澤", "少女心事"),
    "pink_snowflake_07.png": ("天然紋理", "獨一無二"),
    "pink_snowflake_08.png": ("晨光微露", "溫暖相伴"),
    "pink_snowflake_09.png": ("輕盈如羽", "溫柔呵護"),
    "pink_snowflake_10.png": ("書香氣息", "知性優雅"),
    "pink_snowflake_11.png": ("冰雪奇緣", "純潔無瑕"),
    "pink_snowflake_12.png": ("絲滑觸感", "奢華體驗"),
    "pink_snowflake_13.png": ("夢幻光影", "唯美意境"),
}

marketing_texts_sc = {
    "pink_snowflake_cover.png": ("粉白雪花手串", "冰清玉洁·浪漫守护"),
    "pink_snowflake_01.png": ("温婉动人", "气质穿搭"),
    "pink_snowflake_02.png": ("浪漫气息", "点缀腕间"),
    "pink_snowflake_03.png": ("晶莹剔透", "雪花内景"),
    "pink_snowflake_04.png": ("复古情怀", "岁月静好"),
    "pink_snowflake_05.png": ("诗意生活", "艺术之美"),
    "pink_snowflake_06.png": ("柔美色泽", "少女心事"),
    "pink_snowflake_07.png": ("天然纹理", "独一无二"),
    "pink_snowflake_08.png": ("晨光微露", "温暖相伴"),
    "pink_snowflake_09.png": ("轻盈如羽", "温柔呵护"),
    "pink_snowflake_10.png": ("书香气息", "知性优雅"),
    "pink_snowflake_11.png": ("冰雪奇缘", "纯洁无瑕"),
    "pink_snowflake_12.png": ("丝滑触感", "奢华体验"),
    "pink_snowflake_13.png": ("梦幻光影", "唯美意境"),
}
...
def add_border_and_shadow(img, border_size=4, shadow_size=20, shadow_opacity=60):
    # Use a soft icy white border for the snowflake style
    bordered = ImageOps.expand(img, border=border_size, fill='#f4f6f9') 
...
def process_image(img_filename, out_filename, text_tc, text_sc, is_front=False):
    ...
    for lang, texts in [("TC", text_tc), ("SC", text_sc)]:
        ...
        # Dark charcoal text for light backgrounds (common for this product)
        text_fill = (255, 235, 205) if not is_light_bg else (50, 50, 50)
        shadow_fill = (0, 0, 0, 90) if not is_light_bg else (255, 255, 255, 180)
...
def process_promo():
    print("Generating gifted report promo image (Ethereal Winter Frost Style)...")
    
    # 1. Background - Ethereal Winter Frost Style
    bg_path = os.path.join(ASSETS_DIR, "pink_snowflake_report_bg.png")
    ...
    # Paste reports onto bg - "Soft Diagonal Cascade" layout
    center_x = TARGET_WIDTH // 2 + 100
    center_y = TARGET_HEIGHT // 2
    
    bg.paste(r1_styled, (center_x - 50, center_y - r1_styled.height//2 - 60), r1_styled)
    bg.paste(r2_styled, (center_x + 120, center_y - r2_styled.height//2 + 60), r2_styled)
    ...
    texts = {
        "TC": [("結緣贈送", 110), ("專屬八字五行分析報告", 60), ("冰清玉潔 · 浪漫守護", 45)],
        "SC": [("结缘赠送", 110), ("专属八字五行分析报告", 60), ("冰清玉洁 · 浪漫守护", 45)]
    }
    ...
    for lang, lines in texts.items():
        ...
        for text, size in lines:
            ...
            # Deep rose gold / charcoal text with white shadow
            draw_text_with_shadow(draw, (120, y_offset), text, font, (70, 50, 60), (255,255,255,200))
            y_offset += size + 40

        out_dir = os.path.join(OUTPUT_BASE_DIR, lang)
        os.makedirs(out_dir, exist_ok=True)
        out_path = os.path.join(out_dir, "14_pink_snowflake_report_promo.png")
        img_copy.convert("RGB").save(out_path, "PNG")
        print(f"Saved {out_path}")

def main():
    print("Processing Pink-White Snowflake images...")
    
    process_image("pink_snowflake_cover.png", "00_pink_snowflake_cover.png", 
                  marketing_texts_tc["pink_snowflake_cover.png"], 
                  marketing_texts_sc["pink_snowflake_cover.png"], 
                  is_front=True)
                  
    images_to_process = [
        "pink_snowflake_01.png", "pink_snowflake_02.png", "pink_snowflake_03.png", "pink_snowflake_04.png",
        "pink_snowflake_05.png", "pink_snowflake_06.png", "pink_snowflake_07.png", "pink_snowflake_08.png",
        "pink_snowflake_09.png", "pink_snowflake_10.png", "pink_snowflake_11.png", "pink_snowflake_12.png",
        "pink_snowflake_13.png"
    ]
    
    for i, img_key in enumerate(images_to_process, 1):
        out_name = f"{i:02d}_pink_snowflake.png"
