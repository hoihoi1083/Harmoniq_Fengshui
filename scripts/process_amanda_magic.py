...
OUTPUT_BASE_DIR = "/Users/michaelng/Desktop/marketing/Amanda Magic 天然白水晶手串_ad_material_20260507"
...
# --- Marketing Texts ---
marketing_texts_tc = {
    "amanda_cover.png": ("Amanda Magic 天然白水晶", "純淨無暇·淨化磁場"),
    "amanda_01.png": ("晶瑩剔透", "氣質優雅"),
    "amanda_02.png": ("經典百搭", "璀璨奪目"),
    "amanda_03.png": ("極致純淨", "完美無瑕"),
    "amanda_04.png": ("光影交錯", "靈動閃耀"),
    "amanda_05.png": ("尊貴好禮", "傳遞心意"),
    "amanda_06.png": ("職場穿搭", "自信從容"),
    "amanda_07.png": ("陽光折射", "耀眼光芒"),
    "amanda_08.png": ("靜享時光", "溫暖陪伴"),
    "amanda_09.png": ("時尚精緻", "點亮細節"),
    "amanda_10.png": ("質感非凡", "奢華大氣"),
    "amanda_11.png": ("禪意生活", "平衡身心"),
}

marketing_texts_sc = {
    "amanda_cover.png": ("Amanda Magic 天然白水晶", "纯净无暇·净化磁场"),
    "amanda_01.png": ("晶莹剔透", "气质优雅"),
    "amanda_02.png": ("经典百搭", "璀璨夺目"),
    "amanda_03.png": ("极致纯净", "完美无瑕"),
    "amanda_04.png": ("光影交错", "灵动闪耀"),
    "amanda_05.png": ("尊贵好礼", "传递心意"),
    "amanda_06.png": ("职场穿搭", "自信从容"),
    "amanda_07.png": ("阳光折射", "耀眼光芒"),
    "amanda_08.png": ("静享时光", "温暖陪伴"),
    "amanda_09.png": ("时尚精致", "点亮细节"),
    "amanda_10.png": ("质感非凡", "奢华大气"),
    "amanda_11.png": ("禅意生活", "平衡身心"),
}
...
def add_border_and_shadow(img, border_size=3, shadow_size=20, shadow_opacity=60):
    # Use a soft pearl/silver border
    bordered = ImageOps.expand(img, border=border_size, fill='#f0f0f5') 
...
def process_promo():
    print("Generating gifted report promo image (Soft Pearl Silk Style)...")
    
    # 1. Background - Soft Pearl Silk Style
    bg_path = os.path.join(ASSETS_DIR, "amanda_report_bg.png")
    ...
    # Paste reports onto bg - Neat Cascade layout
    # Staggered diagonally from top-right to bottom-center
    bg.paste(r2_styled, (TARGET_WIDTH - r2_styled.width - 150, 100), r2_styled)
    bg.paste(r1_styled, (TARGET_WIDTH - r1_styled.width - 350, 300), r1_styled)
    ...
    for lang, lines in texts.items():
        ...
        for text, size in lines:
            ...
            # Dark charcoal text with white shadow for bright background
            draw_text_with_shadow(draw, (120, y_offset), text, font, (40, 40, 40), (255,255,255,180))
            y_offset += size + 40

        out_dir = os.path.join(OUTPUT_BASE_DIR, lang)
        os.makedirs(out_dir, exist_ok=True)
        out_path = os.path.join(out_dir, "12_amanda_report_promo.png")
        img_copy.convert("RGB").save(out_path, "PNG")
        print(f"Saved {out_path}")

def main():
    print("Processing Amanda Magic Clear Quartz images...")
    
    process_image("amanda_cover.png", "00_amanda_cover.png", 
                  marketing_texts_tc["amanda_cover.png"], 
                  marketing_texts_sc["amanda_cover.png"], 
                  is_front=True)
                  
    images_to_process = [
        "amanda_01.png", "amanda_02.png", "amanda_03.png", "amanda_04.png",
        "amanda_05.png", "amanda_06.png", "amanda_07.png", "amanda_08.png",
        "amanda_09.png", "amanda_10.png", "amanda_11.png"
    ]
    
    for i, img_key in enumerate(images_to_process, 1):
        out_name = f"{i:02d}_amanda.png"
