...
OUTPUT_BASE_DIR = "/Users/michaelng/Desktop/marketing/黑曜石海蓝宝手串_ad_material_20260508"
...
# --- Marketing Texts ---
marketing_texts_tc = {
    "obsidian_aqua_cover.png": ("黑曜石海藍寶手串", "辟邪擋煞·守護寧靜"),
    "obsidian_aqua_01.png": ("沉穩大氣", "彰顯品味"),
    "obsidian_aqua_02.png": ("靜心凝神", "禪意東方"),
    "obsidian_aqua_03.png": ("冰透海藍", "點睛之筆"),
    "obsidian_aqua_04.png": ("溫潤細膩", "質感非凡"),
    "obsidian_aqua_05.png": ("大道至簡", "力量之源"),
    "obsidian_aqua_06.png": ("如海清透", "潤澤心靈"),
    "obsidian_aqua_07.png": ("天然原礦", "能量守護"),
    "obsidian_aqua_08.png": ("黑曜光澤", "辟邪化煞"),
    "obsidian_aqua_09.png": ("尊貴禮遇", "典藏佳品"),
    "obsidian_aqua_10.png": ("神秘深邃", "靈性之光"),
    "obsidian_aqua_11.png": ("文人雅韻", "內斂奢華"),
    "obsidian_aqua_12.png": ("奢華質感", "腕間風華"),
    "obsidian_aqua_13.png": ("獨特設計", "匠心獨運"),
}

marketing_texts_sc = {
    "obsidian_aqua_cover.png": ("黑曜石海蓝宝手串", "辟邪挡煞·守护宁静"),
    "obsidian_aqua_01.png": ("沉稳大气", "彰显品味"),
    "obsidian_aqua_02.png": ("静心凝神", "禅意东方"),
    "obsidian_aqua_03.png": ("冰透海蓝", "点睛之笔"),
    "obsidian_aqua_04.png": ("温润细腻", "质感非凡"),
    "obsidian_aqua_05.png": ("大道至简", "力量之源"),
    "obsidian_aqua_06.png": ("如海清透", "润泽心灵"),
    "obsidian_aqua_07.png": ("天然原矿", "能量守护"),
    "obsidian_aqua_08.png": ("黑曜光泽", "辟邪化煞"),
    "obsidian_aqua_09.png": ("尊贵礼遇", "典藏佳品"),
    "obsidian_aqua_10.png": ("神秘深邃", "灵性之光"),
    "obsidian_aqua_11.png": ("文人雅韵", "内敛奢华"),
    "obsidian_aqua_12.png": ("奢华质感", "腕间风华"),
    "obsidian_aqua_13.png": ("独特设计", "匠心独运"),
}
...
def add_border_and_shadow(img, border_size=4, shadow_size=40, shadow_opacity=150):
    # Use a soft silver-blue border for this style
    bordered = ImageOps.expand(img, border=border_size, fill='#a8c0d8') 
    shadow = Image.new('RGBA', (bordered.width + shadow_size*2, bordered.height + shadow_size*2), (0,0,0,0))
    shadow_draw = ImageDraw.Draw(shadow)
    # Deep navy blue shadow
    shadow_draw.rectangle([shadow_size, shadow_size, bordered.width+shadow_size, bordered.height+shadow_size], fill=(10,20,40,shadow_opacity))
...
def process_image(img_filename, out_filename, text_tc, text_sc, is_front=False):
    ...
    for lang, texts in [("TC", text_tc), ("SC", text_sc)]:
        ...
        # Pale silver/blue text for dark backgrounds, dark charcoal for light
        text_fill = (220, 235, 255) if not is_light_bg else (30, 35, 40) 
...
def process_promo():
    print("Generating gifted report promo image (Midnight Ocean & Silver Moon Style)...")
    
    # 1. Background - Midnight Ocean
    bg_path = os.path.join(ASSETS_DIR, "obsidian_aqua_report_bg.png")
    ...
    for x in range(TARGET_WIDTH // 2):
        alpha = int(220 * (1 - x/(TARGET_WIDTH // 2)))
        draw_overlay.line([(x, 0), (x, TARGET_HEIGHT)], fill=(0,5,15, alpha))
    ...
    # Paste reports onto bg - "Moonlight Reflection" layout (one higher, one lower, slightly overlapping)
    center_x = TARGET_WIDTH // 2 + 150
    center_y = TARGET_HEIGHT // 2
    
    bg.paste(r1_styled, (center_x - r1_styled.width//2 - 120, center_y - r1_styled.height//2 - 80), r1_styled)
    bg.paste(r2_styled, (center_x - r2_styled.width//2 + 120, center_y - r2_styled.height//2 + 80), r2_styled)
    ...
    texts = {
        "TC": [("結緣贈送", 110), ("專屬八字五行分析報告", 60), ("辟邪擋煞 · 守護寧靜", 45)],
        "SC": [("结缘赠送", 110), ("专属八字五行分析报告", 60), ("辟邪挡煞 · 守护宁静", 45)]
    }
    ...
    for lang, lines in texts.items():
        ...
        for text, size in lines:
            ...
            # Pale ice blue/silver text with dark shadow for midnight background
            draw_text_with_shadow(draw, (120, y_offset), text, font, (220, 235, 255), (0,0,0,220))
            y_offset += size + 40

        out_dir = os.path.join(OUTPUT_BASE_DIR, lang)
        os.makedirs(out_dir, exist_ok=True)
        out_path = os.path.join(out_dir, "14_obsidian_aqua_report_promo.png")
        img_copy.convert("RGB").save(out_path, "PNG")
        print(f"Saved {out_path}")

def main():
    print("Processing Obsidian Aquamarine images...")
    
    process_image("obsidian_aqua_cover.png", "00_obsidian_aqua_cover.png", 
                  marketing_texts_tc["obsidian_aqua_cover.png"], 
                  marketing_texts_sc["obsidian_aqua_cover.png"], 
                  is_front=True)
                  
    images_to_process = [
        "obsidian_aqua_01.png", "obsidian_aqua_02.png", "obsidian_aqua_03.png", "obsidian_aqua_04.png",
        "obsidian_aqua_05.png", "obsidian_aqua_06.png", "obsidian_aqua_07.png", "obsidian_aqua_08.png",
        "obsidian_aqua_09.png", "obsidian_aqua_10.png", "obsidian_aqua_11.png", "obsidian_aqua_12.png",
        "obsidian_aqua_13.png"
    ]
    
    for i, img_key in enumerate(images_to_process, 1):
        out_name = f"{i:02d}_obsidian_aqua.png"
