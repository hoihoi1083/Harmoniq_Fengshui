...
OUTPUT_BASE_DIR = "/Users/michaelng/Desktop/marketing/天然黑金超手链_ad_material_20260508"
...
# --- Marketing Texts ---
marketing_texts_tc = {
    "black_gold_super_cover.png": ("天然黑金超手鏈", "招財聚氣·能量非凡"),
    "black_gold_super_01.png": ("高貴優雅", "氣質之選"),
    "black_gold_super_02.png": ("靜享奢華", "品味生活"),
    "black_gold_super_03.png": ("髮絲綿密", "光芒璀璨"),
    "black_gold_super_04.png": ("天然原礦", "醇厚質感"),
    "black_gold_super_05.png": ("尊貴禮遇", "典藏佳品"),
    "black_gold_super_06.png": ("知性魅力", "自信閃耀"),
    "black_gold_super_07.png": ("黑金交織", "獨特風景"),
    "black_gold_super_08.png": ("溫暖觸感", "細膩呵護"),
    "black_gold_super_09.png": ("純潔高雅", "宛如初見"),
    "black_gold_super_10.png": ("強大氣場", "霸氣外露"),
    "black_gold_super_11.png": ("晶瑩剔透", "內含乾坤"),
    "black_gold_super_12.png": ("沐浴陽光", "能量滿滿"),
    "black_gold_super_13.png": ("極致奢華", "彰顯身份"),
}

marketing_texts_sc = {
    "black_gold_super_cover.png": ("天然黑金超手链", "招财聚气·能量非凡"),
    "black_gold_super_01.png": ("高贵优雅", "气质之选"),
    "black_gold_super_02.png": ("静享奢华", "品味生活"),
    "black_gold_super_03.png": ("发丝绵密", "光芒璀璨"),
    "black_gold_super_04.png": ("天然原矿", "醇厚质感"),
    "black_gold_super_05.png": ("尊贵礼遇", "典藏佳品"),
    "black_gold_super_06.png": ("知性魅力", "自信闪耀"),
    "black_gold_super_07.png": ("黑金交织", "独特风景"),
    "black_gold_super_08.png": ("温暖触感", "细腻呵护"),
    "black_gold_super_09.png": ("纯洁高雅", "宛如初见"),
    "black_gold_super_10.png": ("强大气场", "霸气外露"),
    "black_gold_super_11.png": ("晶莹剔透", "内含乾坤"),
    "black_gold_super_12.png": ("沐浴阳光", "能量满满"),
    "black_gold_super_13.png": ("极致奢华", "彰显身份"),
}
...
def add_border_and_shadow(img, border_size=3, shadow_size=25, shadow_opacity=80):
    # Use an elegant thin gold border for this style
...
def process_image(img_filename, out_filename, text_tc, text_sc, is_front=False):
    ...
    for lang, texts in [("TC", text_tc), ("SC", text_sc)]:
        ...
        # Pale gold text for dark backgrounds, dark charcoal for light
        text_fill = (238, 221, 187) if not is_light_bg else (40, 40, 40) 
...
def process_promo():
    print("Generating gifted report promo image (Dark Charcoal & Gold Streaks Style)...")
    
    # 1. Background - Dark Charcoal & Gold Streaks
    bg_path = os.path.join(ASSETS_DIR, "black_gold_super_report_bg.png")
    ...
    # Resize reports - Asymmetrical sizes
    r1_h = 550
    r2_h = 480
    ...
    # Paste reports onto bg - "Asymmetrical Floating" layout
    center_x = TARGET_WIDTH // 2 + 150
    center_y = TARGET_HEIGHT // 2
    
    # Place smaller one behind and lower, larger one in front and higher
    bg.paste(r2_styled, (center_x + 80, center_y - r2_styled.height//2 + 80), r2_styled)
    bg.paste(r1_styled, (center_x - 120, center_y - r1_styled.height//2 - 40), r1_styled)
    ...
    texts = {
        "TC": [("結緣贈送", 110), ("專屬八字五行分析報告", 60), ("招財聚氣 · 能量非凡", 45)],
        "SC": [("结缘赠送", 110), ("专属八字五行分析报告", 60), ("招财聚气 · 能量非凡", 45)]
    }
    ...
    for lang, lines in texts.items():
        ...
        for text, size in lines:
            ...
            draw_text_with_shadow(draw, (120, y_offset), text, font, (238, 221, 187), (0,0,0,220))
            y_offset += size + 40

        out_dir = os.path.join(OUTPUT_BASE_DIR, lang)
        os.makedirs(out_dir, exist_ok=True)
        out_path = os.path.join(out_dir, "14_black_gold_super_report_promo.png")
        img_copy.convert("RGB").save(out_path, "PNG")
        print(f"Saved {out_path}")

def main():
    print("Processing Black Gold Super Seven images...")
    
    process_image("black_gold_super_cover.png", "00_black_gold_super_cover.png", 
                  marketing_texts_tc["black_gold_super_cover.png"], 
                  marketing_texts_sc["black_gold_super_cover.png"], 
                  is_front=True)
                  
    images_to_process = [
        "black_gold_super_01.png", "black_gold_super_02.png", "black_gold_super_03.png", "black_gold_super_04.png",
        "black_gold_super_05.png", "black_gold_super_06.png", "black_gold_super_07.png", "black_gold_super_08.png",
        "black_gold_super_09.png", "black_gold_super_10.png", "black_gold_super_11.png", "black_gold_super_12.png",
        "black_gold_super_13.png"
    ]
    
    for i, img_key in enumerate(images_to_process, 1):
        out_name = f"{i:02d}_black_gold_super.png"
