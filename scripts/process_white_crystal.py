...
OUTPUT_BASE_DIR = "/Users/michaelng/Desktop/marketing/白水晶手串_ad_material_20260507"
...
# --- Marketing Texts ---
marketing_texts_tc = {
    "white_crystal_cover.png": ("天然白水晶手串", "純淨無暇·淨化磁場"),
    "white_crystal_01.png": ("晶瑩剔透", "氣質清新"),
    "white_crystal_02.png": ("純淨天然", "如冰似水"),
    "white_crystal_03.png": ("細節之美", "點睛之筆"),
    "white_crystal_04.png": ("水潤柔美", "靈動光澤"),
    "white_crystal_05.png": ("完美好禮", "傳遞心意"),
    "white_crystal_06.png": ("職場穿搭", "自信從容"),
    "white_crystal_07.png": ("陽光折射", "耀眼光芒"),
    "white_crystal_08.png": ("靜心品茗", "禪意生活"),
    "white_crystal_09.png": ("時尚百搭", "點亮細節"),
    "white_crystal_10.png": ("寧靜致遠", "平衡身心"),
    "white_crystal_11.png": ("極簡美學", "質感非凡"),
}

marketing_texts_sc = {
    "white_crystal_cover.png": ("天然白水晶手串", "纯净无暇·净化磁场"),
    "white_crystal_01.png": ("晶莹剔透", "气质清新"),
    "white_crystal_02.png": ("纯净天然", "如冰似水"),
    "white_crystal_03.png": ("细节之美", "点睛之笔"),
    "white_crystal_04.png": ("水润柔美", "灵动光泽"),
    "white_crystal_05.png": ("完美好礼", "传递心意"),
    "white_crystal_06.png": ("职场穿搭", "自信从容"),
    "white_crystal_07.png": ("阳光折射", "耀眼光芒"),
    "white_crystal_08.png": ("静心品茗", "禅意生活"),
    "white_crystal_09.png": ("时尚百搭", "点亮细节"),
    "white_crystal_10.png": ("宁静致远", "平衡身心"),
    "white_crystal_11.png": ("极简美学", "质感非凡"),
}
...
def add_border_and_shadow(img, border_size=2, shadow_size=20):
    bordered = ImageOps.expand(img, border=border_size, fill='#e0f7fa') # light blue border
    shadow = Image.new('RGBA', (bordered.width + shadow_size*2, bordered.height + shadow_size*2), (0,0,0,0))
    shadow_draw = ImageDraw.Draw(shadow)
    shadow_draw.rectangle([shadow_size, shadow_size, bordered.width+shadow_size, bordered.height+shadow_size], fill=(0,0,0,30))
...
def process_promo():
    print("Generating gifted report promo image (Ethereal Water Style)...")
    
    # 1. Background - Ethereal Water Style
    bg_path = os.path.join(ASSETS_DIR, "white_crystal_report_bg.png")
    bg = Image.open(bg_path).convert("RGB")
    bg = ImageOps.fit(bg, (TARGET_WIDTH, TARGET_HEIGHT), Image.Resampling.LANCZOS)
    
    # Subtle white overlay on the left to make text readable against bright water
    ...
    # Paste reports onto bg - Centered overlapping layout for a different look
    center_x = TARGET_WIDTH // 2 + 150
    bg.paste(r2_styled, (center_x - 50, (TARGET_HEIGHT - r2_styled.height)//2 - 40), r2_styled)
    bg.paste(r1_styled, (center_x - r1_styled.width + 100, (TARGET_HEIGHT - r1_styled.height)//2 + 40), r1_styled)
    ...
    texts = {
        "TC": [("結緣贈送", 110), ("專屬八字五行分析報告", 60), ("淨化磁場 · 靈動如水", 45)],
        "SC": [("结缘赠送", 110), ("专属八字五行分析报告", 60), ("净化磁场 · 灵动如水", 45)]
    }
    ...
    for lang, lines in texts.items():
        ...
        out_dir = os.path.join(OUTPUT_BASE_DIR, lang)
        os.makedirs(out_dir, exist_ok=True)
        out_path = os.path.join(out_dir, "12_white_crystal_report_promo.png")
        img_copy.convert("RGB").save(out_path, "PNG")
        print(f"Saved {out_path}")

def main():
    print("Processing White Crystal images...")
    
    process_image("white_crystal_cover.png", "00_white_crystal_cover.png", 
                  marketing_texts_tc["white_crystal_cover.png"], 
                  marketing_texts_sc["white_crystal_cover.png"], 
                  is_front=True)
                  
    images_to_process = [
        "white_crystal_01.png", "white_crystal_02.png", "white_crystal_03.png", "white_crystal_04.png",
        "white_crystal_05.png", "white_crystal_06.png", "white_crystal_07.png", "white_crystal_08.png",
        "white_crystal_09.png", "white_crystal_10.png", "white_crystal_11.png"
    ]
    
    for i, img_key in enumerate(images_to_process, 1):
        out_name = f"{i:02d}_white_crystal.png"
