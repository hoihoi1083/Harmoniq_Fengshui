...
OUTPUT_BASE_DIR = "/Users/michaelng/Desktop/marketing/醒獅銀耀石手串_ad_material_20260508"
...
# --- Marketing Texts ---
marketing_texts_tc = {
    "silver_obsidian_cover.png": ("醒獅銀耀石手串", "霸氣護主·招財辟邪"),
    "silver_obsidian_01.png": ("男士專屬", "彰顯品味"),
    "silver_obsidian_02.png": ("沉穩大氣", "成功標配"),
    "silver_obsidian_03.png": ("精雕醒獅", "栩栩如生"),
    "silver_obsidian_04.png": ("銀光閃耀", "深邃迷人"),
    "silver_obsidian_05.png": ("天然原礦", "能量強大"),
    "silver_obsidian_06.png": ("國潮風範", "文化傳承"),
    "silver_obsidian_07.png": ("運籌帷幄", "自信從容"),
    "silver_obsidian_08.png": ("低調奢華", "質感非凡"),
    "silver_obsidian_09.png": ("百搭造型", "型男必備"),
    "silver_obsidian_10.png": ("細膩打磨", "圓潤飽滿"),
    "silver_obsidian_11.png": ("靜心凝神", "護佑平安"),
    "silver_obsidian_12.png": ("品味生活", "從容不迫"),
    "silver_obsidian_13.png": ("尊貴好禮", "饋贈佳品"),
}

marketing_texts_sc = {
    "silver_obsidian_cover.png": ("醒狮银耀石手串", "霸气护主·招财辟邪"),
    "silver_obsidian_01.png": ("男士专属", "彰显品味"),
    "silver_obsidian_02.png": ("沉稳大气", "成功标配"),
    "silver_obsidian_03.png": ("精雕醒狮", "栩栩如生"),
    "silver_obsidian_04.png": ("银光闪耀", "深邃迷人"),
    "silver_obsidian_05.png": ("天然原矿", "能量强大"),
    "silver_obsidian_06.png": ("国潮风范", "文化传承"),
    "silver_obsidian_07.png": ("运筹帷幄", "自信从容"),
    "silver_obsidian_08.png": ("低调奢华", "质感非凡"),
    "silver_obsidian_09.png": ("百搭造型", "型男必备"),
    "silver_obsidian_10.png": ("细腻打磨", "圆润饱满"),
    "silver_obsidian_11.png": ("静心凝神", "护佑平安"),
    "silver_obsidian_12.png": ("品味生活", "从容不迫"),
    "silver_obsidian_13.png": ("尊贵好礼", "馈赠佳品"),
}
...
def add_border_and_shadow(img, border_size=4, shadow_size=20, shadow_opacity=60):
    # Use a dark, sleek silver/grey border for the masculine style
    bordered = ImageOps.expand(img, border=border_size, fill='#2c3e50') 
...
def process_image(img_filename, out_filename, text_tc, text_sc, is_front=False):
    ...
    for lang, texts in [("TC", text_tc), ("SC", text_sc)]:
        ...
        text_fill = (220, 220, 220) if not is_light_bg else (40, 40, 40) # Silver/grey text for dark bg
        shadow_fill = (0, 0, 0, 180) if not is_light_bg else (255, 255, 255, 150)
...
def process_promo():
    print("Generating gifted report promo image (Dark Slate & Silver Style)...")
    
    # 1. Background - Dark Slate & Silver Style
    bg_path = os.path.join(ASSETS_DIR, "silver_obsidian_report_bg.png")
    bg = Image.open(bg_path).convert("RGB")
    bg = ImageOps.fit(bg, (TARGET_WIDTH, TARGET_HEIGHT), Image.Resampling.LANCZOS)
    
    # Subtle dark overlay on the left for text
    ...
    # Paste reports onto bg - "Executive Desk" layout (neatly stacked, slightly angled)
    ...
    bg.paste(r1_rot, (center_x - 100, center_y - r1_rot.height//2 - 20), r1_rot)
    bg.paste(r2_rot, (center_x + 150, center_y - r2_rot.height//2 + 40), r2_rot)
    ...
    texts = {
        "TC": [("結緣贈送", 110), ("專屬八字五行分析報告", 60), ("霸氣護主 · 招財辟邪", 45)],
        "SC": [("结缘赠送", 110), ("专属八字五行分析报告", 60), ("霸气护主 · 招财辟邪", 45)]
    }
    ...
    for lang, lines in texts.items():
        ...
        for text, size in lines:
            ...
            # Silver text with dark shadow
            draw_text_with_shadow(draw, (120, y_offset), text, font, (220, 220, 220), (0,0,0,200))
            y_offset += size + 40

        out_dir = os.path.join(OUTPUT_BASE_DIR, lang)
        os.makedirs(out_dir, exist_ok=True)
        out_path = os.path.join(out_dir, "14_silver_obsidian_report_promo.png")
        img_copy.convert("RGB").save(out_path, "PNG")
        print(f"Saved {out_path}")

def main():
    print("Processing Silver Obsidian Lion Head images...")
    
    process_image("silver_obsidian_cover.png", "00_silver_obsidian_cover.png", 
                  marketing_texts_tc["silver_obsidian_cover.png"], 
                  marketing_texts_sc["silver_obsidian_cover.png"], 
                  is_front=True)
                  
    images_to_process = [
        "silver_obsidian_01.png", "silver_obsidian_02.png", "silver_obsidian_03.png", "silver_obsidian_04.png",
        "silver_obsidian_05.png", "silver_obsidian_06.png", "silver_obsidian_07.png", "silver_obsidian_08.png",
        "silver_obsidian_09.png", "silver_obsidian_10.png", "silver_obsidian_11.png", "silver_obsidian_12.png",
        "silver_obsidian_13.png"
    ]
    
    for i, img_key in enumerate(images_to_process, 1):
        out_name = f"{i:02d}_silver_obsidian.png"
