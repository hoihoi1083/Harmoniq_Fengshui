...
OUTPUT_BASE_DIR = "/Users/michaelng/Desktop/marketing/蓝月光手串_ad_material_20260508"
...
# --- Marketing Texts ---
marketing_texts_tc = {
    "blue_moonstone_cover.png": ("天然藍月光手串", "情感治癒·安撫情緒"),
    "blue_moonstone_01.png": ("溫柔婉約", "氣質非凡"),
    "blue_moonstone_02.png": ("月光清輝", "靜靜入懷"),
    "blue_moonstone_03.png": ("炫藍藍眼", "晶彩流動"),
    "blue_moonstone_04.png": ("溫潤細膩", "質感非凡"),
    "blue_moonstone_05.png": ("大道至簡", "自然之美"),
    "blue_moonstone_06.png": ("如水溫柔", "潤澤心靈"),
    "blue_moonstone_07.png": ("顆顆嚴選", "剔除瑕疵"),
    "blue_moonstone_08.png": ("藍光閃爍", "靈動迷人"),
    "blue_moonstone_09.png": ("尊貴禮遇", "典藏佳品"),
    "blue_moonstone_10.png": ("浪漫守護", "情人之石"),
    "blue_moonstone_11.png": ("奢華質感", "腕間風華"),
    "blue_moonstone_12.png": ("純潔無暇", "靜心凝神"),
}

marketing_texts_sc = {
    "blue_moonstone_cover.png": ("天然蓝月光手串", "情感治愈·安抚情绪"),
    "blue_moonstone_01.png": ("温柔婉约", "气质非凡"),
    "blue_moonstone_02.png": ("月光清辉", "静静入怀"),
    "blue_moonstone_03.png": ("炫蓝蓝眼", "晶彩流动"),
    "blue_moonstone_04.png": ("温润细腻", "质感非凡"),
    "blue_moonstone_05.png": ("大道至简", "自然之美"),
    "blue_moonstone_06.png": ("如水温柔", "润泽心灵"),
    "blue_moonstone_07.png": ("颗颗严选", "剔除瑕疵"),
    "blue_moonstone_08.png": ("蓝光闪烁", "灵动迷人"),
    "blue_moonstone_09.png": ("尊贵礼遇", "典藏佳品"),
    "blue_moonstone_10.png": ("浪漫守护", "情人之石"),
    "blue_moonstone_11.png": ("奢华质感", "腕间风华"),
    "blue_moonstone_12.png": ("纯洁无暇", "静心凝神"),
}
...
def add_border_and_shadow(img, border_size=4, shadow_size=40, shadow_opacity=150):
    # Use a soft glowing white/pale blue border for this style
    bordered = ImageOps.expand(img, border=border_size, fill='#e0f0ff') 
    shadow = Image.new('RGBA', (bordered.width + shadow_size*2, bordered.height + shadow_size*2), (0,0,0,0))
    shadow_draw = ImageDraw.Draw(shadow)
    # Deep blue/black shadow
    shadow_draw.rectangle([shadow_size, shadow_size, bordered.width+shadow_size, bordered.height+shadow_size], fill=(5,10,25,shadow_opacity))
...
def process_image(img_filename, out_filename, text_tc, text_sc, is_front=False):
    ...
    for lang, texts in [("TC", text_tc), ("SC", text_sc)]:
        ...
        # Pale glowing blue/white text for dark backgrounds, dark charcoal for light
        text_fill = (230, 245, 255) if not is_light_bg else (30, 35, 40) 
...
def process_promo():
    print("Generating gifted report promo image (Ethereal Night Sky & Glowing Clouds Style)...")
    
    # 1. Background - Ethereal Night Sky & Glowing Clouds
    bg_path = os.path.join(ASSETS_DIR, "blue_moonstone_report_bg.png")
    ...
    # Paste reports onto bg - "Floating Ascend" layout (one lower left, one higher right, overlapping)
    center_x = TARGET_WIDTH // 2 + 150
    center_y = TARGET_HEIGHT // 2
    
    bg.paste(r1_styled, (center_x - r1_styled.width + 80, center_y - r1_styled.height//2 + 60), r1_styled)
    bg.paste(r2_styled, (center_x - 30, center_y - r2_styled.height//2 - 60), r2_styled)
    ...
    texts = {
        "TC": [("結緣贈送", 110), ("專屬八字五行分析報告", 60), ("情感治癒 · 安撫情緒", 45)],
        "SC": [("结缘赠送", 110), ("专属八字五行分析报告", 60), ("情感治愈 · 安抚情绪", 45)]
    }
    ...
    for lang, lines in texts.items():
        ...
        for text, size in lines:
            ...
            # Pale glowing blue/white text with dark shadow for night sky background
            draw_text_with_shadow(draw, (120, y_offset), text, font, (230, 245, 255), (0,0,0,220))
            y_offset += size + 40

        out_dir = os.path.join(OUTPUT_BASE_DIR, lang)
        os.makedirs(out_dir, exist_ok=True)
        out_path = os.path.join(out_dir, "13_blue_moonstone_report_promo.png")
        img_copy.convert("RGB").save(out_path, "PNG")
        print(f"Saved {out_path}")

def main():
    print("Processing Blue Moonstone images...")
    
    process_image("blue_moonstone_cover.png", "00_blue_moonstone_cover.png", 
                  marketing_texts_tc["blue_moonstone_cover.png"], 
                  marketing_texts_sc["blue_moonstone_cover.png"], 
                  is_front=True)
                  
    images_to_process = [
        "blue_moonstone_01.png", "blue_moonstone_02.png", "blue_moonstone_03.png", "blue_moonstone_04.png",
        "blue_moonstone_05.png", "blue_moonstone_06.png", "blue_moonstone_07.png", "blue_moonstone_08.png",
        "blue_moonstone_09.png", "blue_moonstone_10.png", "blue_moonstone_11.png", "blue_moonstone_12.png"
    ]
    
    for i, img_key in enumerate(images_to_process, 1):
        out_name = f"{i:02d}_blue_moonstone.png"
