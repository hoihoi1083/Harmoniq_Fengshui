...
7. Point 5要讓用戶感受到價值但留有懸念，引導解鎖詳細報告`;
	...
	static async generateCoupleAIAnalysis(
		...
		const prompt = `你是專業的風水師「小鈴」，請根據以下信息生成個人化的合婚配對分析：
