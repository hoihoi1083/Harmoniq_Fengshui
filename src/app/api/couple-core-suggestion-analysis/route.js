...
export async function POST(request) {
	try {
		...
		const prompt = isSimplified
			? `
作为专业的夫妻八字合盘分析师，我深深理解经营一段长久关系的不易。每对夫妻都有独特的相处模式和挑战，让我为你们提供详细的感情开运建议：
...
## 分析要求
请从以下四个维度进行夫妻合盘分析，用温暖共情的语言，每个维度提供详细的实用建议：
...
💡 **实际场景示例：**
- 周末一起做早餐：男方准备食材，女方负责烹饪，在厨房里的默契配合能增进感情
- 每月定期理财会议：一起规划家庭开支和储蓄目标，培养共同责任感
- 睡前十分钟聊天时光：关掉手机，分享今天发生的趣事或烦恼，增进情感连结
- 每季度一次小旅行：体验新环境新事物，为平淡的生活注入新鲜感
...
💡 **实际场景示例：**
- 吵架后的和解：等情绪平复后，找个安静的空间（如咖啡厅或公园），心平气和地说出自己的感受和需求，避免翻旧账
- 讨论敏感话题：选择双方都放松的时刻（如周末下午），用"我感觉..."代替"你总是..."，表达感受而非指责
- 日常互动：每天至少一次真诚的拥抱或牵手，身体接触比千言万语更能传递爱意
- 表达不满：用"三明治沟通法"——先肯定优点→提出建议→表达期待，让对方更容易接受
...
`
			: `
作為專業的夫妻八字合盤分析師，我深深理解經營一段長久關係的不易。每對夫妻都有獨特的相處模式和挑戰，讓我為你們提供詳細的感情開運建議：
...
## 分析要求
請從以下四個維度進行夫妻合盤分析，用溫暖共情的語言，每個維度提供詳細的實用建議：
...
💡 **實際場景示例：**
- 週末一起做早餐：男方準備食材，女方負責烹飪，在廚房裡的默契配合能增進感情
- 每月定期理財會議：一起規劃家庭開支和儲蓄目標，培養共同責任感
- 睡前十分鐘聊天時光：關掉手機，分享今天發生的趣事或煩惱，增進情感連結
- 每季度一次小旅行：體驗新環境新事物，為平淡的生活注入新鮮感
...
💡 **實際場景示例：**
- 吵架後的和解：等情緒平復後，找個安靜的空間（如咖啡廳或公園），心平氣和地說出自己的感受和需求，避免翻舊賬
- 討論敏感話題：選擇雙方都放鬆的時刻（如週末下午），用「我感覺...」代替「你總是...」，表達感受而非指責
- 日常互動：每天至少一次真誠的擁抱或牽手，身體接觸比千言萬語更能傳遞愛意
- 表達不滿：用「三明治溝通法」——先肯定優點→提出建議→表達期待，讓對方更容易接受
