...
export async function POST(request) {
	try {
		...
		const session = await stripe.checkout.sessions.create({
			// 🍎 APPLE PAY FIX: Let Stripe automatically enable all available payment methods
			// Don't specify payment_method_types to allow Apple Pay, Google Pay, Link, and cards
			// WeChat Pay and Alipay removed as they're not enabled in live account
			line_items: [
				{
