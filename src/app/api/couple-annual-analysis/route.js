...
async function generateAnnualStrategyWithAI(
	...
	try {
		...
		const prompt = isSimplified
			? `作为专业的八字合盤分析师，我了解每对夫妻都希望提前知道未来一年可能面临的挑战和机遇。让我为你们详细分析流年运势：
...
1. **${currentYear}年感情运势分析**
   ...
   💡 **实际场景示例：**
   - 3-4月感情升温期：可以计划一次浪漫旅行，选择山水之地增进感情
   - 7-8月矛盾高发期：避免讨论敏感话题（如财务、家人），先处理情绪再沟通
   - 10-11月关系稳定期：适合共同做重要决定，如购房、生育计划等
...
2. **${nextYear}年关键应对策略**
   ...
   💡 **实际场景示例：**
   - 新年伊始：一起制定年度感情目标和家庭预算，增强责任感
   - 遇到财务压力：提前设立应急储备金，避免因钱产生争执
   - 家庭关系紧张：定期举行家庭会议，倾听彼此心声
...
3. **具体月份建议**
   ...
   💡 **实际场景示例：**
   - 每月初一十五：一起到寺庙祈福或在家点香，培养共同信仰
   - 农历七月：避免搬家、装修等大动作，多关心对方情绪变化
   - 本命年月份：为对方准备红色内衣或配饰，表达关心
...
请用简体中文回答，格式要清晰专业。`
			: `作為專業的八字合盤分析師，我了解每對夫妻都希望提前知道未來一年可能面臨的挑戰和機遇。讓我為你們詳細分析流年運勢：
...
1. **${currentYear}年感情運勢分析**
   ...
   💡 **實際場景示例：**
   - 3-4月感情升溫期：可以計劃一次浪漫旅行，選擇山水之地增進感情
   - 7-8月矛盾高發期：避免討論敏感話題（如財務、家人），先處理情緒再溝通
   - 10-11月關係穩定期：適合共同做重要決定，如購房、生育計畫等
...
2. **${nextYear}年關鍵應對策略**
   ...
   💡 **實際場景示例：**
   - 新年伊始：一起制定年度感情目標和家庭預算，增強責任感
   - 遇到財務壓力：提前設立應急儲備金，避免因錢產生爭執
   - 家庭關係緊張：定期舉行家庭會議，傾聽彼此心聲
...
3. **具體月份建議**
   ...
   💡 **實際場景示例：**
   - 每月初一十五：一起到寺廟祈福或在家點香，培養共同信仰
   - 農曆七月：避免搬家、裝修等大動作，多關心對方情緒變化
   - 本命年月份：為對方準備紅色內衣或配飾，表達關心
