...
export function getDisplayPrices(locale, region = null) {
	...
	const prices = {
		CNY: {
			fengshui: { original: 1188, discount: 818 },
			life: { original: 888, discount: 628 },
			fortune: { original: 538, discount: 348 },
			wealth: { original: 538, discount: 348 },
			relationship: { original: 538, discount: 348 },
			couple: { original: 888, discount: 628 },
			health: { original: 538, discount: 348 },
			career: { original: 538, discount: 348 },
		},
		HKD: {
			fengshui: { original: 1288, discount: 888 },
			life: { original: 988, discount: 688 },
			fortune: { original: 588, discount: 388 },
			wealth: { original: 588, discount: 388 },
			relationship: { original: 88, discount: 38 },
			couple: { original: 988, discount: 688 },
			health: { original: 588, discount: 388 },
			career: { original: 588, discount: 388 },
		},
		TWD: {
			fengshui: { original: 5288, discount: 3688 },
			life: { original: 3988, discount: 2688 },
			fortune: { original: 2388, discount: 1588 },
			wealth: { original: 2388, discount: 1588 },
			relationship: { original: 2388, discount: 1588 },
			couple: { original: 3988, discount: 2688 },
			health: { original: 2388, discount: 1588 },
			career: { original: 2388, discount: 1588 },
		},
	};
